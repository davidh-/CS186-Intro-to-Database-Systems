...
public class TestJoinOperator {
    ...
    */
    ...
    @Category(StudentTestP3.class)
    public void testPNLJHandlesNoMoreRecords() throws Exception {
      TestSourceOperator sourceOperator = new TestSourceOperator();
      File tempDir = tempFolder.newFolder("joinTest");
      Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
      ...
      assertEquals(outputIterator.hasNext(), false);
      outputIterator.next();
    }
    @Test (expected = NoSuchElementException.class)
    @Category(StudentTestP3.class)
    public void testBNLJHandlesNoMoreRecords() throws Exception {
      TestSourceOperator sourceOperator = new TestSourceOperator();
      File tempDir = tempFolder.newFolder("joinTest");
      Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
    ...
    @Test (expected = NoSuchElementException.class)
    @Category(StudentTestP3.class)
    public void testGHJHandlesNoMoreRecords() throws Exception {
      TestSourceOperator sourceOperator = new TestSourceOperator();
      File tempDir = tempFolder.newFolder("joinTest");
      Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
    ...
    @Test (expected = NoSuchElementException.class)
    @Category(StudentTestP3.class)
    public void testSortMergeJoinHandlesNoMoreRecords() throws Exception {
      TestSourceOperator sourceOperator = new TestSourceOperator();
      File tempDir = tempFolder.newFolder("joinTest");
      Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
    ...
    @Test (expected = NoSuchElementException.class)
    @Category(StudentTestP3.class)
    public void testIndexScanHandlesNoMoreRecords() throws Exception {
      File tempDir = tempFolder.newFolder("joinTest");
      ...
      transaction.addRecord("myTable", r1.getValues());
      ...
      List<DataBox> expectedRecord3 = new ArrayList<DataBox>();

      for (int i = 0; i < 1; i++) {
        for (DataBox val : r1Vals) {
          expectedRecord3.add(val);
        }
      }
      while (outputIterator.hasNext()) {
      ...
      d.deleteTable("mytable");

      QueryOperator s2 = new IndexScanOperator(transaction, "myTable", "int", QueryPlan.PredicateOperator.EQUALS, new IntDataBox(3));
      Iterator<Record> outputIterator2 = s2.iterator();
      assertFalse(outputIterator2.hasNext());
      outputIterator2.next();
    }
    @Test
    @Category(StudentTestP3.class)
    public void testPNLJHandlesMultiplePages() throws Exception {
      File tempDir = tempFolder.newFolder("joinTest");
    ...
    @Test
    @Category(StudentTestP3.class)
    public void testBNLJHandlesMultiplePages() throws Exception {
      File tempDir = tempFolder.newFolder("joinTest");
      Database d = new Database(tempDir.getAbsolutePath(), 4);
      Database.Transaction transaction = d.beginTransaction();
      Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
    ...
    @Test
    @Category(StudentTestP3.class)
    public void testGraceHashJoinHandlesMultiplePages() throws Exception {
      File tempDir = tempFolder.newFolder("joinTest");
      Database d = new Database(tempDir.getAbsolutePath(), 4);
      Database.Transaction transaction = d.beginTransaction();
      Record r1 = TestUtils.createRecordWithAllTypesWithValue(1);
    ...
    @Test
    @Category(StudentTestP3.class)
    public void testSortMergeJoinHandlesMultiplePages() throws Exception {
      TestSourceOperator sourceOperator = new TestSourceOperator();
      File tempDir = tempFolder.newFolder("joinTest");
      Database.Transaction transaction = new Database(tempDir.getAbsolutePath()).beginTransaction();
      JoinOperator joinOperator = new SortMergeOperator(sourceOperator, sourceOperator, "int", "int", transaction);
    ...
    @Test (expected = NoSuchElementException.class)
    @Category(StudentTestP3.class)
    public void testIndexScanHandlesMultiplePages() throws Exception {
      File tempDir = tempFolder.newFolder("joinTest");
      Database d = new Database(tempDir.getAbsolutePath(), 4);
      Database.Transaction transaction = d.beginTransaction();
      List<String> indexList = new ArrayList<String>();
